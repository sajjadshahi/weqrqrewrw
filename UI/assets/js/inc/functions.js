...
$("body")
  .undelegate(".login__block [data-block]")
  .delegate(".login__block [data-block]", "click", function(e) {
    e.preventDefault();
...
$("body")
  .undelegate(".form-group--float .form-control")
  .delegate(".form-group--float .form-control", "blur", function() {
    var i = $(this).val();
    var p = $(this).parent();
...
$(document).ready(function() {
  ...
  if ($("#widget-weather__main")[0]) {
    ...
    $.simpleWeather({
      ...
      success: function(weather) {
        var html =
          '<div class="widget-weather__current clearfix">' +
          '<div class="widget-weather__icon widget-weather__icon-' +
          weather.code +
          '"></div>' +
        ...
        setTimeout(function() {
          for (i = 0; i < 5; i++) {
            var l =
              '<li class="media">' +
              '<span class="pull-left widget-weather__icon widget-weather__icon-sm widget-weather__icon-' +
  ...
  if ($(".action-header__search")[0]) {
    ...
    $("body").on("click", ".action-header__toggle", function(e) {
      ...
      actionHeaderSearch = $(this)
        .closest(".action-header")
        .find(".action-header__search");
