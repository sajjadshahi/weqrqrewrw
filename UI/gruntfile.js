module.exports = function(grunt) {
    ...
    var cssFiles = ['assets/css/**/**/*.css', '!assets/css/app-1.css', '!assets/css/app-2.css', '!assets/css/app-3.css'],
    ...
    grunt.initConfig({
        ...
        cssmin: {
            minify: {
                ...
                expand: true,
                src: ['assets/css/*.css', '!assets/css/*.min.css', '!assets/css/app.css'],
                ext: '.min.css'
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    'assets/js/app.min.js': ['assets/js/inc/functions.js', 'assets/js/inc/actions.js']
                }
            }
        },
